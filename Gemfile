...
gem "importmap-rails"
# React integration with Rails [https://github.com/shakacode/react_on_rails]
...
gem "devise"
# Google OAuth2 for Devise [https://github.com/zquestz/omniauth-google-oauth2]
gem "omniauth-google-oauth2"
gem "omniauth-rails_csrf_protection"

# Square SDK for payment processing
gem "square.rb", "~> 44.0", ">= 44.0.0.20250820"
...
# Google Drive API for gallery photos
